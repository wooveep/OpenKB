...
This initial package does not yet ship the optional DeepDoc or legacy Office
compatibility runtimes; later tickets add those components and their notices.
