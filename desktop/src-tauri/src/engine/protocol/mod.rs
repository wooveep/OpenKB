...
pub use crate::engine::wire::knowledge_export::{
    KnowledgeExportMode, KnowledgeExportPreview, KnowledgeExportResult,
};
pub use crate::engine::wire::knowledge_pages::{
...
impl EngineSupervisor {
    ...
    fn spawn_engine(&self) -> BridgeResult<()> {
        ...
        diagnostics::logging::configure_engine_command(&mut command);
        ...
        diagnostics::logging::spawn_engine_stderr_reporter(stderr);
        Ok(())
    }
