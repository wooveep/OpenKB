...
mod tests {
    use super::{
        KnowledgeAdoptionMatch, KnowledgeAdoptionResult, KnowledgeExportResult,
        KnowledgeVerificationState, KnowledgeVerificationStatus, KnowledgeWorkspaceHistory,
        KnowledgeWorkspaceItemDetail, KnowledgeWorkspaceItemRequest, KnowledgeWorkspaceItemSummary,
