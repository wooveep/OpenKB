import type { SemanticReviews } from "@/desktop/bridge/contracts/semantic-reviews"
...
} from "@/desktop/bridge/normalizers"
import { TauriDocumentVersionBridge } from "@/desktop/bridge/tauri/document-version-bridge"
import { UnavailableKnowledgeReanalysisBridge } from "@/desktop/bridge/unavailable/knowledge-reanalysis-bridge"
...
class UnavailableDesktopBridge extends UnavailableKnowledgeReanalysisBridge implements DesktopBridge {
  ...
  semanticReviews(): Promise<SemanticReviews> { return this.unavailable() }
  resolveSemanticReview(): Promise<SemanticReviews> { return this.unavailable() }
