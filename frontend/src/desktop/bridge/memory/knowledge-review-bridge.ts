...
import { MemoryKnowledgePageBridge } from "@/desktop/bridge/memory/knowledge-page-bridge"
...
export abstract class MemoryKnowledgeReviewBridge extends MemoryKnowledgePageBridge {
  ...
  async semanticReviews(): Promise<SemanticReviews> { return { items: [] } }
  async resolveSemanticReview(): Promise<SemanticReviews> {
    throw new Error("No semantic review snapshot is available in this preview.")
  }
