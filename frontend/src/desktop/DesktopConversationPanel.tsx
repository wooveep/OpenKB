...
function AssistantMessage({ message, stream, onRegenerate, onSelectVersion, onOpenEvidence }: { message: DesktopConversation["messages"][number]; stream?: StreamState; onRegenerate: () => void; onSelectVersion: (id: string) => void; onOpenEvidence: (version: DesktopAnswerVersion, tab: "sources" | "images", focusIndex?: number | null) => void }) {
  const { t } = useTranslation("common")
