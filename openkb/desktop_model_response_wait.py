...
def wait_for_model_response(
    ...
    *,
    ...
    """Wait for a daemon provider worker until completion, cancellation, or deadline."""
    completed = threading.Event()
    outcome: dict[str, object] = {}
    response_started_at = clock()
    ...
    while not completed.wait(0.05):
        ...
        expired = response_timeout_seconds is not None and (
            clock() - response_started_at >= response_timeout_seconds
        )
