...
from openkb.desktop_knowledge_generations import normalized_knowledge_content
...
def _equivalent_hunks(left: _MergeHunk, right: _MergeHunk) -> bool:
    return (
        ...
        == tuple(
            _merge_unit_identity(value, ignore_source_markers=True) for value in right[2]
        )
    )
