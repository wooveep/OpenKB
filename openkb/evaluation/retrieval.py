...
from openkb.evaluation.retrieval_stability import stability_for
...
from openkb.knowledge.graph.feature_flags import (
...
from openkb.retrieval.service import (
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    from openkb.evaluation.retrieval_cli import run
