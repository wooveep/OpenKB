...
class DesktopModelOperationCompletionAuthority:
    ...
    @classmethod
    def for_retry_scope(cls, retry_scope: str | None) -> DesktopModelOperationCompletionAuthority:
...
def authorize_model_operation_retry_group_in(
    ...
    *,
    ...
    for operation, capability_identity, digest in _resolved_retry_contracts(gateway, contracts):
...
def revoke_model_operation_retry_scope_in(connection: sqlite3.Connection, retry_scope: str) -> None:
