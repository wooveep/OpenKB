...
from openkb.knowledge.analysis.synthesis_prompts import (
    fact_harvest_instructions,
    knowledge_analysis_instructions,
    knowledge_output_example,
)
from openkb.knowledge.corpus.review_contract import CLAIM_REVIEW_INSTRUCTIONS, CLAIM_REVIEW_SCHEMA
...
_CONTRACTS["knowledge_claim_review"] = _contract(
    "knowledge_claim_review",
    CLAIM_REVIEW_INSTRUCTIONS,
    output_schema=CLAIM_REVIEW_SCHEMA,
    output_example={
        "review_id": "review-1",
        "verdict": "unresolved",
        "evidence_ids": ["evidence-1"],
    },
    input_shape={"type": "corpus_claim_comparison", "evidence_bound": True},
    validation_rules=("known_evidence_ids_only", "immutable_candidate_generation_binding"),
)
