...
from openkb.diagnostics.logging import log_event, trace_event
from openkb.diagnostics.sensitive_trace import sensitive_trace_component_enabled
...
from openkb.models.active_streams import once as _once
...
from openkb.models.http_lifecycle import terminal_completion_client
    ...
    def _terminal_completion(
        ...
        *,
        ...
        try:
            ...
            timeout = Timeout(connect=connect_timeout_seconds, read=None, write=None, pool=None)
