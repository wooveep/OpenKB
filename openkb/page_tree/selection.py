...
from openkb.page_tree.store import lease_current_page_tree
from openkb.page_tree.tree import PageTreeGeneration, PageTreeNode
        ...
        with ExitStack() as stack:
            ...
            try:
                ...
                return PageTreeSelectionResult(
                    generation_ids=generation_ids,
                    trigger_reasons=triggers,
                    degradation_reasons=("page_tree_selection_budget_exhausted",),
