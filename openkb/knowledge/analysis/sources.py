...
from openkb.knowledge.pages.generations import KnowledgeGenerationSource
...
def bind_generation_sources_to_draft_in(
    ...
    *,
    ...
    selected = tuple(
        ...
        if knowledge_source_matches_claim(content_markdown, source.source_id, source.claim_text)
    )
