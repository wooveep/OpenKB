...
from openkb.knowledge.corpus.candidate_registry import candidate_registry_outcome_in
...
def qualify_corpus_manifest_in(
    ...
    from openkb.knowledge.pages.store import generation_knowledge_page_issues_in
