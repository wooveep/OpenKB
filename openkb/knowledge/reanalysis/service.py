...
from openkb.knowledge.reanalysis import store as reanalysis_store
from openkb.knowledge.reanalysis.corpus import activate_completed_corpus_reanalysis_in
from openkb.knowledge.reanalysis.graph import requeue_reanalysis_graphs
from openkb.knowledge.reanalysis.models import (
...
from openkb.knowledge.reanalysis.recovery import (
...
from openkb.page_tree.store import lease_current_page_tree, load_current_page_tree_in
from openkb.page_tree.tree import PageTreeGeneration
from openkb.retrieval.catalog_store import queue_catalog_rebuild_in, start_catalog_rebuilds
    ...
    def _apply_result(
        ...
        if refine_corpus:
            try:
                ...
                logger.exception("Could not refine Reanalysis Knowledge Pages.")
