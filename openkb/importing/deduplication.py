...
from openkb.documents.source_image_assets import persist_source_images
from openkb.importing.artifacts import DocumentIRBlock, SourceImage
from openkb.importing.types import DesktopDeduplication, DesktopImportedDocument
...
def _find_available_document_in(
    ...
    from openkb.importing.queries import find_available_document_in
