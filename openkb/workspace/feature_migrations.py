...
from openkb.documents.missing_source_migrations import MISSING_SOURCE_MIGRATION_STATEMENTS
from openkb.documents.version_catalog_migrations import (
    DOCUMENT_VERSION_CATALOG_MIGRATION_STATEMENTS,
)
from openkb.importing.recovery_migrations import IMPORT_PARSER_RECOVERY_MIGRATION_STATEMENTS
from openkb.knowledge.analysis.batch_migrations import (
    KNOWLEDGE_ANALYSIS_BATCH_MIGRATION_STATEMENTS,
)
from openkb.knowledge.analysis.migrations import (
...
from openkb.knowledge.analysis.plan_migrations import (
    KNOWLEDGE_ANALYSIS_PLAN_MIGRATION_STATEMENTS,
)
from openkb.knowledge.corpus.candidate_registry_migrations import (
    CANDIDATE_REGISTRY_MIGRATION_STATEMENTS,
)
from openkb.knowledge.corpus.integrity_migrations import CORPUS_INTEGRITY_MIGRATION_STATEMENTS
from openkb.knowledge.corpus.knowledge_migrations import CORPUS_KNOWLEDGE_MIGRATION_STATEMENTS
from openkb.knowledge.corpus.review_store import SEMANTIC_REVIEW_MIGRATION_STATEMENTS
from openkb.knowledge.corpus.synthesis_task_migrations import (
    CORPUS_SYNTHESIS_TASK_MIGRATION_STATEMENTS,
)
from openkb.knowledge.corpus.work_queue import CORPUS_WORK_QUEUE_MIGRATION_STATEMENTS
from openkb.knowledge.graph.result_migrations import (
    KNOWLEDGE_GRAPH_CURRENT_REVISION_MIGRATION_STATEMENTS,
    KNOWLEDGE_GRAPH_RESULT_MIGRATION_STATEMENTS,
)
from openkb.knowledge.graph.semantic_authority_migrations import (
    SEMANTIC_AUTHORITY_MIGRATION_STATEMENTS,
)
from openkb.knowledge.graph.task_migrations import (
    KNOWLEDGE_GRAPH_RETRY_SCOPE_MIGRATION_STATEMENTS,
    KNOWLEDGE_GRAPH_TASK_MIGRATION_STATEMENTS,
)
from openkb.knowledge.pages import lifecycle_migrations as lifecycle_migrations
from openkb.knowledge.pages import migrations as knowledge_page_migrations
from openkb.knowledge.pages import verification_migrations as verification_migrations
...
from openkb.knowledge.pages.link_migrations import (
    CATALOG_RELATIONSHIP_MIGRATION_STATEMENTS,
)
from openkb.knowledge.pages.okf_projection_migrations import OKF_PROJECTION_MIGRATION_STATEMENTS
from openkb.knowledge.pages.plan_cache import PAGE_PLAN_CACHE_MIGRATION_STATEMENTS
from openkb.knowledge.pages.provenance_migrations import (
    KNOWLEDGE_PROVENANCE_MIGRATION_STATEMENTS,
)
from openkb.knowledge.pages.source_migrations import KNOWLEDGE_SOURCE_MIGRATION_STATEMENTS
from openkb.knowledge.reanalysis import migrations as reanalysis_migrations
from openkb.knowledge.reconciliation.migrations import (
    THREE_WAY_KNOWLEDGE_RECONCILIATION_MIGRATION_STATEMENTS,
)
from openkb.models.capability_migrations import MODEL_CAPABILITY_MIGRATION_STATEMENTS
from openkb.models.legacy_recovery_migrations import (
    LEGACY_MODEL_RECOVERY_MIGRATION_STATEMENTS,
)
from openkb.models.observability_migrations import MODEL_LIFECYCLE_MIGRATION_STATEMENTS
...
from openkb.models.result_migrations import (
    MODEL_RESULT_OBSERVATION_MIGRATION_STATEMENTS,
)
from openkb.models.usage_migrations import MODEL_USAGE_MIGRATION_STATEMENTS
from openkb.page_tree import migrations as page_tree_migrations
from openkb.page_tree.enrichment_migrations import (
    PAGE_TREE_ENRICHMENT_MIGRATION_STATEMENTS,
    PAGE_TREE_ENRICHMENT_RETRY_SCOPE_MIGRATION_STATEMENTS,
)
from openkb.retrieval.catalog_migrations import (
    CATALOG_ELIGIBILITY_MIGRATION_STATEMENTS,
    CATALOG_MIGRATION_STATEMENTS,
)
from openkb.retrieval.trace_migrations import RETRIEVAL_TRACE_MIGRATION_STATEMENTS
from openkb.workspace.migrations import (
...
RETRY_SCOPE_REVISION_MIGRATION_VERSION = 52
CORPUS_KNOWLEDGE_MIGRATION_VERSION = 53
CORPUS_INTEGRITY_MIGRATION_VERSION = 54
CATALOG_RELATIONSHIP_MIGRATION_VERSION = 55
RESERVED_SEMANTIC_CUTOVER_MIGRATION_VERSION = 56
CATALOG_ELIGIBILITY_MIGRATION_VERSION = 57
RESERVED_GRAPH_CUTOVER_MIGRATION_VERSION = 58
CANDIDATE_REGISTRY_MIGRATION_VERSION = 59
DOCUMENT_VERSION_CATALOG_MIGRATION_VERSION = 60
RESERVED_GRAPH_BINDING_CUTOVER_MIGRATION_VERSION = 61
CORPUS_SYNTHESIS_TASK_MIGRATION_VERSION = 62
RESERVED_INVENTORY_CUTOVER_MIGRATION_VERSION = 63
SEMANTIC_AUTHORITY_MIGRATION_VERSION = 64
...
DESKTOP_FEATURE_MIGRATIONS: tuple[tuple[int, tuple[str, ...]], ...] = (
    ...
    (
        RETRY_SCOPE_REVISION_MIGRATION_VERSION,
        MODEL_OPERATION_RETRY_REVISION_MIGRATION_STATEMENTS
        + KNOWLEDGE_GRAPH_RETRY_SCOPE_MIGRATION_STATEMENTS
        + PAGE_TREE_ENRICHMENT_RETRY_SCOPE_MIGRATION_STATEMENTS,
    ),
    (CORPUS_KNOWLEDGE_MIGRATION_VERSION, CORPUS_KNOWLEDGE_MIGRATION_STATEMENTS),
    (CORPUS_INTEGRITY_MIGRATION_VERSION, CORPUS_INTEGRITY_MIGRATION_STATEMENTS),
    (CATALOG_RELATIONSHIP_MIGRATION_VERSION, CATALOG_RELATIONSHIP_MIGRATION_STATEMENTS),
    (RESERVED_SEMANTIC_CUTOVER_MIGRATION_VERSION, ()),
    (CATALOG_ELIGIBILITY_MIGRATION_VERSION, CATALOG_ELIGIBILITY_MIGRATION_STATEMENTS),
    (RESERVED_GRAPH_CUTOVER_MIGRATION_VERSION, ()),
    (CANDIDATE_REGISTRY_MIGRATION_VERSION, CANDIDATE_REGISTRY_MIGRATION_STATEMENTS),
    (
        DOCUMENT_VERSION_CATALOG_MIGRATION_VERSION,
        DOCUMENT_VERSION_CATALOG_MIGRATION_STATEMENTS,
    ),
    (RESERVED_GRAPH_BINDING_CUTOVER_MIGRATION_VERSION, ()),
    (
        CORPUS_SYNTHESIS_TASK_MIGRATION_VERSION,
        CORPUS_SYNTHESIS_TASK_MIGRATION_STATEMENTS,
    ),
    (RESERVED_INVENTORY_CUTOVER_MIGRATION_VERSION, ()),
    (SEMANTIC_AUTHORITY_MIGRATION_VERSION, SEMANTIC_AUTHORITY_MIGRATION_STATEMENTS),
    (65, IMPORT_PARSER_RECOVERY_MIGRATION_STATEMENTS),
    (66, CORPUS_WORK_QUEUE_MIGRATION_STATEMENTS),
    (67, PAGE_PLAN_CACHE_MIGRATION_STATEMENTS),
    (68, SEMANTIC_REVIEW_MIGRATION_STATEMENTS),
)
