...
from openkb.models.settings import DesktopModelSettingsError
from openkb.models.structured_output import (
    DesktopStructuredOutputInvalidError,
    run_structured_output,
)
from openkb.retrieval.plan import deterministic_plan, with_baseline_terms
from openkb.retrieval.query_planning import (
...
def build_query_plan(
    ...
    *,
    ...
    except ModelDispatchBudgetExhausted:
        reason = "query_planning_budget_exhausted"
