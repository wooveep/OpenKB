...
from openkb.documents.version_scope import NavigationSnapshot, RetrievalRequest
...
from openkb.page_tree.selection import (
    PageTreeLeaseFactory,
    PageTreeSelectionResult,
    select_page_tree_evidence,
)
from openkb.page_tree.store import lease_current_page_tree, lease_page_tree_generation
from openkb.page_tree.tree import PageTreeGeneration
from openkb.retrieval.candidates import (
    catalog_channel_candidates as _scoped_catalog_channel_candidates,
)
from openkb.retrieval.candidates import (
    page_tree_candidates as _scoped_page_tree_candidates,
)
from openkb.retrieval.candidates import variant_evidence as _scoped_variant_evidence
from openkb.retrieval.catalog_lease import (
    best_effort_catalog_lease as _best_effort_catalog_lease,
)
from openkb.retrieval.catalog_store import lease_catalog_generation
...
from openkb.retrieval.images import source_images_for_evidence
from openkb.retrieval.navigation.adaptive import (
    NAVIGATION_MAX_WALL_SECONDS,
    current_navigation_snapshot_id,
)
from openkb.retrieval.navigation.knowledge import (
    NAVIGATION_MAX_READS,
    NAVIGATION_MAX_SOURCE_WINDOWS,
    DesktopKnowledgeNavigationResult,
    build_knowledge_navigation_in,
)
from openkb.retrieval.navigation.session import run_navigation_session
from openkb.retrieval.plan import deterministic_plan, validate_question
from openkb.retrieval.planning import (
    DesktopRetrievalPlanningResult,
    build_query_plan,
)
from openkb.retrieval.scoped_evidence import (
    ScopedEvidenceView,
...
from openkb.retrieval.version_context import (
...
class DesktopEvidenceRetriever:
    ...
    def retrieve(
        ...
        *,
        ...
        planning = build_query_plan(
            ...
            dispatch_deadline=navigation_deadline,
        )
        ...
        initial_pack = self.retrieve_variant(
            ...
            _model_dispatch_deadline=navigation_deadline,
        )
    ...
    def retrieve_variant(
        ...
        *,
        ...
        _model_dispatch_deadline: float | None = None,
        ...
        if retrieval_plan is None:
            planning_result = build_query_plan(
                ...
                on_model_event=on_model_event,
                retry_scope=(operation_retry_scopes or {}).get("query_planning"),
                dispatch_deadline=_model_dispatch_deadline,
            )
