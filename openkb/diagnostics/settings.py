...
_COMPONENT_PREFIXES = (
    ("openkb.diagnostics.model_failures", "model"),
    ("openkb.diagnostics.imports", "import"),
    ("openkb.diagnostics.engine", "bridge"),
    ("openkb.engine.page_tree", "page_tree"),
    ("openkb.engine.knowledge", "knowledge"),
    ("openkb.engine.model", "model"),
    ("openkb.engine.imports", "import"),
    ("openkb.models", "model"),
    ("openkb.importing", "import"),
    ("openkb.parsers", "parser"),
    ("openkb.page_tree", "page_tree"),
    ("openkb.documents.missing_source", "projection"),
    ("openkb.knowledge.pages.okf_projection", "projection"),
    ("openkb.retrieval.catalog", "storage"),
    ("openkb.retrieval", "retrieval"),
    ("openkb.answers", "retrieval"),
    ("openkb.knowledge", "knowledge"),
    ("openkb.workspace", "storage"),
    ("openkb.storage", "storage"),
    ("openkb.locks", "storage"),
    ("openkb.engine", "bridge"),
)
