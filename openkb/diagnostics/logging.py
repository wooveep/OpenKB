...
to :mod:`openkb.diagnostics.sensitive_trace`.
"""
...
from openkb.diagnostics.handler import HybridDiagnosticHandler, migrate_plaintext_logs
...
def configure_desktop_engine_logging(
    ...
    for warning_code in normalized.warnings:
        ...
        log_event(
            logging.getLogger("openkb.diagnostics.logging"),
            logging.WARNING,
