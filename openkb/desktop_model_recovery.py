...
from openkb.desktop_model_result_failure import MODEL_RESULT_FAILURE_CODES
        ...
        *,
        ...
        with kb_ingest_lock(self._state_dir):
            ...
            try:
                ...
                _discard_model_analysis_in(connection, job_id)
...
def _discard_model_analysis_in(connection: sqlite3.Connection, job_id: str) -> None:
